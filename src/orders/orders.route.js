...
const app = express();
app.use(cors({ origin: "https://arkanalgwda.com" }));
...
router.post("/create-checkout-session", async (req, res) => {
  ...
  try {
    ...
    const data = {
      ...
      mode: "payment",
      products: lineItems,
      success_url: "https://arkanalgwda.com/SuccessRedirect?client_reference_id=" + nowId,
      cancel_url: "https://arkanalgwda.com/cancel",
      metadata: {
